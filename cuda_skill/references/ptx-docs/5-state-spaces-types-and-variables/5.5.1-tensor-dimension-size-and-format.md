---
title: "5.5.1. Tensor Dimension, size and format"
section: "5.5.1"
version: "9.4"
url: https://docs.nvidia.com/cuda/parallel-thread-execution/index.html#tensor-dimension-size-format
---

<a id="tensor-dimension-size-format"></a>
...
- [5.5.1.1. Sub-byte Types](5.5.1.1-sub-byte-types.md)
