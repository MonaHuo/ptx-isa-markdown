...
section: "5.5.5.3"
version: "9.4"
url: https://docs.nvidia.com/cuda/parallel-thread-execution/index.html#tensor-im2col-w-w128-modes-whalo
---

<a id="tensor-im2col-w-w128-modes-whalo"></a>
...
A tensor copy operation with the above parameters loads 128 pixels and the two halo pixels as shown in [Figure 19](#tensor-im2col-w-w128-modes-example3).

<a id="tensor-im2col-w-w128-modes-example3"></a>
...
The halo pixels are always loaded in the shared memory next to the main row pixels as shown in [Figure 19](#tensor-im2col-w-w128-modes-example3).
...
A tensor copy operation with the above parameters loads 128 elements such that after every 32 elements, wHalo number of elements are loaded as shown in [Figure 20](#tensor-im2col-w-w128-modes-example4).

<a id="tensor-im2col-w-w128-modes-example4"></a>
