---
title: "5.1.6. Parameter State Space"
section: "5.1.6"
version: "9.4"
url: https://docs.nvidia.com/cuda/parallel-thread-execution/index.html#parameter-state-space
---

<a id="parameter-state-space"></a>
...
- [5.1.6.1. Kernel Function Parameters](5.1.6.1-kernel-function-parameters.md)
- [5.1.6.2. Kernel Function Parameter Attributes](5.1.6.2-kernel-function-parameter-attributes.md)
- [5.1.6.3. Kernel Parameter Attribute: .ptr](5.1.6.3-kernel-parameter-attribute.ptr.md)
- [5.1.6.4. Device Function Parameters](5.1.6.4-device-function-parameters.md)
