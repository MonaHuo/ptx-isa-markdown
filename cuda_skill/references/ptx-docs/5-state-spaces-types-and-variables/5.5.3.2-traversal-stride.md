---
title: "5.5.3.2. Traversal-Stride"
section: "5.5.3.2"
version: "9.4"
url: https://docs.nvidia.com/cuda/parallel-thread-execution/index.html#tensor-tiled-mode-traversal-stride
---

<a id="tensor-tiled-mode-traversal-stride"></a>
...
The traversal stride in dimension 0 can be used for the [Interleave layout](5.5.6-interleave-layout.md#tensor-interleaved-layout). For non-interleaved layout, the traversal stride in dimension 0 must always be 1.
...
<a id="tensor-tiled-mode-bb-example"></a>
