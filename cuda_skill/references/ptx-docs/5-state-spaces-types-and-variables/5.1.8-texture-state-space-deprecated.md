---
title: "5.1.8. Texture State Space (deprecated)"
section: "5.1.8"
version: "9.4"
url: https://docs.nvidia.com/cuda/parallel-thread-execution/index.html#texture-state-space-deprecated
---

<a id="texture-state-space-deprecated"></a>
...
See [Texture Sampler and Surface Types](5.3-texture-sampler-and-surface-types.md#texture-sampler-and-surface-types) for the description of the `.texref` type and [Texture Instructions](../9-instruction-set/9.7.12-texture-instructions.md#texture-instructions) for its use in texture instructions.
