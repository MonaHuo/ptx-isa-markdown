---
title: "9.7.10.22. Data Movement and Conversion Instructions: isspacep"
section: "9.7.10.22"
version: "9.4"
url: https://docs.nvidia.com/cuda/parallel-thread-execution/index.html#data-movement-and-conversion-instructions-isspacep
---

<a id="data-movement-and-conversion-instructions-isspacep"></a>

<a id="id280"></a>

####  9.7.10.22. Data Movement and Conversion Instructions: `isspacep`
...
`isspacep.param{::entry}` returns `1` if the generic address falls within the window of [Kernel Function Parameters](../5-state-spaces-types-and-variables/5.1.6.1-kernel-function-parameters.md#kernel-function-parameters), otherwise returns `0`. If `.param` is specified without any sub-qualifiers then it defaults to `.param::entry`.

`isspacep.global` returns `1` for [Kernel Function Parameters](../5-state-spaces-types-and-variables/5.1.6.1-kernel-function-parameters.md#kernel-function-parameters) as `.param` window is contained within the `.global` window.
