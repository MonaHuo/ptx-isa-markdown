---
title: "9.7.10.9. Data Movement and Conversion Instructions: ld.global.nc"
section: "9.7.10.9"
version: "9.4"
url: https://docs.nvidia.com/cuda/parallel-thread-execution/index.html#data-movement-and-conversion-instructions-ld-global-nc
---

<a id="data-movement-and-conversion-instructions-ld-global-nc"></a>
...
The address operand `a` shall contain a global address. Supported addressing modes for operand `a` and alignment requirements are described in [Addresses as Operands](../6-instruction-operands/6.4.1-addresses-as-operands.md#addresses-as-operands).
