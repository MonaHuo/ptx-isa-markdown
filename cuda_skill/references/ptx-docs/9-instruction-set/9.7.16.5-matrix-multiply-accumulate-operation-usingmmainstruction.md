---
title: "9.7.16.5. Matrix multiply-accumulate operation using mma instruction"
section: "9.7.16.5"
version: "9.4"
url: https://docs.nvidia.com/cuda/parallel-thread-execution/index.html#warp-level-matrix-instructions-for-mma
---

<a id="warp-level-matrix-instructions-for-mma"></a>

<a id="id415"></a>

####  9.7.16.5. Matrix multiply-accumulate operation using `mma` instruction
...
<a id="warp-level-matrix-fragment-mma-884-f16"></a>

<a id="id416"></a>

#####  9.7.16.5.1. Matrix Fragments for `mma.m8n8k4` with `.f16` floating point type
...
The layout of the fragments held by different threads is shown below:
    ...
    * Fragment layout for Row Major matrix A is shown in [Figure 49](#mma-884-a-row-f16).

<a id="mma-884-a-row-f16"></a>

![_images/mma-884-A-row-f16.png](https://docs.nvidia.com/cuda/parallel-thread-execution/_images/mma-884-A-row-f16.png)

Figure 49 MMA .m8n8k4 fragment layout for row-major matrix A with `.f16` type
...
```
    ...
    * Fragment layout for Column Major matrix A is shown in [Figure 50](#mma-884-a-col-f16).

The layout of the fragments held by different threads is shown below:

<a id="mma-884-a-col-f16"></a>

![_images/mma-884-A-col-f16.png](https://docs.nvidia.com/cuda/parallel-thread-execution/_images/mma-884-A-col-f16.png)

Figure 50 MMA .m8n8k4 fragment layout for column-major matrix A with `.f16` type
...
The layout of the fragments held by different threads is shown below:
    ...
    * Fragment layout for Row Major matrix B is shown in [Figure 51](#mma-884-b-row-f16).

<a id="mma-884-b-row-f16"></a>

![_images/mma-884-B-row-f16.png](https://docs.nvidia.com/cuda/parallel-thread-execution/_images/mma-884-B-row-f16.png)

Figure 51 MMA .m8n8k4 fragment layout for row-major matrix B with `.f16` type
...
```
    ...
    * Fragment layout for Column Major matrix B is shown in [Figure 52](#mma-884-b-col-f16).

<a id="mma-884-b-col-f16"></a>

![_images/mma-884-B-col-f16.png](https://docs.nvidia.com/cuda/parallel-thread-execution/_images/mma-884-B-col-f16.png)

Figure 52 MMA .m8n8k4 fragment layout for column-major matrix B with `.f16` type
...
<td><p>A vector expression containing four <code><span>.f16x2</span></code> registers, with
each register containing two <code><span>.f16</span></code> elements from the matrix
C (or D).</p></td>
<td rowspan="2"><p>c0, c1, c2, c3, c4, c5, c6, c7</p></td>
</tr>
<tr>
<td><p><code><span>.f32</span></code></p></td>
<td><p>A vector expression of eight <code><span>.f32</span></code> registers.</p></td>
</tr>
</tbody>
</table>
...
The layout of the fragments held by different threads is shown below:
    ...
    * Fragment layout for accumulator matrix when `.ctype` is `.f16` is shown in [Figure 53](#mma-884-c-f16).

<a id="mma-884-c-f16"></a>

![_images/mma-884-C-f16.png](https://docs.nvidia.com/cuda/parallel-thread-execution/_images/mma-884-C-f16.png)

Figure 53 MMA .m8n8k4 fragment layout for matrix C/D with `.ctype` = `.f16`
...
```
    ...
    * Fragment layout for accumulator matrix when `.ctype` is `.f32` is shown in [Figure 54](#mma-884-c-f32-1) and [Figure 55](#mma-884-c-f32-2).

<a id="mma-884-c-f32-1"></a>

![_images/mma-884-C-f32-1.png](https://docs.nvidia.com/cuda/parallel-thread-execution/_images/mma-884-C-f32-1.png)

Figure 54 MMA .m8n8k4 computation 1 and 2 fragment layout for matrix C/D with `.ctype` = `.f32`

<a id="mma-884-c-f32-2"></a>

![_images/mma-884-C-f32-2.png](https://docs.nvidia.com/cuda/parallel-thread-execution/_images/mma-884-C-f32-2.png)

Figure 55 MMA .m8n8k4 computation 3 and 4 fragment layout for matrix C/D with `.ctype` = `.f32`
...
<a id="warp-level-matrix-fragment-mma-884-f64"></a>

<a id="id417"></a>

#####  9.7.16.5.2. Matrix Fragments for `mma.m8n8k4` with `.f64` floating point type
...
The layout of the fragments held by different threads is shown in [Figure 56](#mma-884-a-f64).

<a id="mma-884-a-f64"></a>

![_images/mma-884-A-f64.png](https://docs.nvidia.com/cuda/parallel-thread-execution/_images/mma-884-A-f64.png)

Figure 56 MMA .m8n8k4 fragment layout for matrix A with `.f64` type
...
The layout of the fragments held by different threads is shown in [Figure 57](#mma-884-b-f64).

<a id="mma-884-b-f64"></a>

![_images/mma-884-B-f64.png](https://docs.nvidia.com/cuda/parallel-thread-execution/_images/mma-884-B-f64.png)

Figure 57 MMA .m8n8k4 fragment layout for matrix B with `.f64` type
...
The layout of the fragments held by different threads is shown in [Figure 58](#mma-884-c-f64).

<a id="mma-884-c-f64"></a>

![_images/mma-884-C-f64.png](https://docs.nvidia.com/cuda/parallel-thread-execution/_images/mma-884-C-f64.png)

Figure 58 MMA .m8n8k4 fragment layout for accumulator matrix C/D with `.f64` type
...
<a id="warp-level-matrix-fragment-mma-8816"></a>

<a id="id418"></a>

#####  9.7.16.5.3. Matrix Fragments for `mma.m8n8k16`
...
The layout of the fragments held by different threads is shown in [Figure 59](#mma-8816-a-i8).

<a id="mma-8816-a-i8"></a>

![_images/mma-8816-A-i8.png](https://docs.nvidia.com/cuda/parallel-thread-execution/_images/mma-8816-A-i8.png)

Figure 59 MMA .m8n8k16 fragment layout for matrix A with `.u8`/`.s8` type
...
The layout of the fragments held by different threads is shown in [Figure 60](#mma-8816-b-i8).

<a id="mma-8816-b-i8"></a>

![_images/mma-8816-B-i8.png](https://docs.nvidia.com/cuda/parallel-thread-execution/_images/mma-8816-B-i8.png)

Figure 60 MMA .m8n8k16 fragment layout for matrix B with `.u8`/`.s8` type
...
The layout of the fragments held by different threads is shown in [Figure 61](#mma-8816-c-i8).

<a id="mma-8816-c-i8"></a>

![_images/mma-8816-C-i8.png](https://docs.nvidia.com/cuda/parallel-thread-execution/_images/mma-8816-C-i8.png)

Figure 61 MMA .m8n8k16 fragment layout for accumulator matrix C/D with `.s32` type
...
<a id="warp-level-matrix-fragment-mma-8832"></a>

<a id="id419"></a>

#####  9.7.16.5.4. Matrix Fragments for `mma.m8n8k32`
...
The layout of the fragments held by different threads is shown in [Figure 62](#mma-8832-a-i4).

<a id="mma-8832-a-i4"></a>

![_images/mma-8832-A-i4.png](https://docs.nvidia.com/cuda/parallel-thread-execution/_images/mma-8832-A-i4.png)

Figure 62 MMA .m8n8k32 fragment layout for matrix A with `.u4`/`.s4` type
...
The layout of the fragments held by different threads is shown in [Figure 63](#mma-8832-b-i4).

<a id="mma-8832-b-i4"></a>

![_images/mma-8832-B-i4.png](https://docs.nvidia.com/cuda/parallel-thread-execution/_images/mma-8832-B-i4.png)

Figure 63 MMA .m8n8k32 fragment layout for matrix B with `.u4`/`.s4` type
...
The layout of the fragments held by different threads is shown in [Figure 64](#mma-8832-c-i4):

<a id="mma-8832-c-i4"></a>

![_images/mma-8832-C-i4.png](https://docs.nvidia.com/cuda/parallel-thread-execution/_images/mma-8832-C-i4.png)

Figure 64 MMA .m8n8k32 fragment layout for accumulator matrix C/D with `.s32` type
...
<a id="warp-level-matrix-fragment-mma-88128"></a>

<a id="id420"></a>

#####  9.7.16.5.5. Matrix Fragments for `mma.m8n8k128`
...
The layout of the fragments held by different threads is shown in [Figure 65](#mma-88128-a).

<a id="mma-88128-a"></a>

![_images/mma-88128-A.png](https://docs.nvidia.com/cuda/parallel-thread-execution/_images/mma-88128-A.png)

Figure 65 MMA .m8n8k128 fragment layout for matrix A with `.b1` type.
...
The layout of the fragments held by different threads is shown in [Figure 66](#mma-88128-b).

<a id="mma-88128-b"></a>

![_images/mma-88128-B.png](https://docs.nvidia.com/cuda/parallel-thread-execution/_images/mma-88128-B.png)

Figure 66 MMA .m8n8k128 fragment layout for matrix B with `.b1` type.
...
The layout of the fragments held by different threads is shown in [Figure 67](#mma-88128-c).

<a id="mma-88128-c"></a>

![_images/mma-88128-C.png](https://docs.nvidia.com/cuda/parallel-thread-execution/_images/mma-88128-C.png)

Figure 67 MMA .m8n8k128 fragment layout for accumulator matrix C/D with `.s32` type
...
<a id="warp-level-matrix-fragment-mma-1684"></a>

<a id="id421"></a>

#####  9.7.16.5.6. Matrix Fragments for `mma.m16n8k4`
...
The layout of the fragments held by different threads is shown in [Figure 68](#mma-1684-a-tf32).

<a id="mma-1684-a-tf32"></a>

![_images/mma-1684-A.png](https://docs.nvidia.com/cuda/parallel-thread-execution/_images/mma-1684-A.png)

Figure 68 MMA .m16n8k4 fragment layout for matrix A with `.tf32` type.
...
>
> The layout of the fragments held by different threads is shown in [Figure 69](#mma-1684-a-f64).
>
> <a id="mma-1684-a-f64"></a>
>
> ![_images/mma-1684-A.png](https://docs.nvidia.com/cuda/parallel-thread-execution/_images/mma-1684-A.png)
>
> Figure 69 MMA .m16n8k4 fragment layout for matrix A with `.f64` type.
>
> The row and column of a matrix fragment can be computed as:
>
> ```ptx
...
>
> The layout of the fragments held by different threads is shown in [Figure 70](#mma-1684-b-tf32).
>
> <a id="mma-1684-b-tf32"></a>
>
> ![_images/mma-1684-B.png](https://docs.nvidia.com/cuda/parallel-thread-execution/_images/mma-1684-B.png)
>
> Figure 70 MMA .m16n8k4 fragment layout for matrix B with `.tf32` type.
>
> The row and column of a matrix fragment can be computed as:
>
> ```ptx
...
>
> The layout of the fragments held by different threads is shown in [Figure 71](#mma-1684-b-f64).
>
> <a id="mma-1684-b-f64"></a>
>
> ![_images/mma-1684-B.png](https://docs.nvidia.com/cuda/parallel-thread-execution/_images/mma-1684-B.png)
>
> Figure 71 MMA .m16n8k4 fragment layout for matrix B with `.f64` type.
>
> The row and column of a matrix fragment can be computed as:
>
> ```ptx
...
>
> The layout of the fragments held by different threads is shown in [Figure 72](#mma-1684-c-f32).
>
> <a id="mma-1684-c-f32"></a>
>
> ![_images/mma-1684-C.png](https://docs.nvidia.com/cuda/parallel-thread-execution/_images/mma-1684-C.png)
>
> Figure 72 MMA .m16n8k4 fragment layout for accumulator matrix C/D with `.f32` type.
>
> The row and column of a matrix fragment can be computed as:
>
> ```ptx
...
>
> The layout of the fragments held by different threads is shown in [Figure 73](#mma-1684-c-f64).
>
> <a id="mma-1684-c-f64"></a>
>
> ![_images/mma-1684-C.png](https://docs.nvidia.com/cuda/parallel-thread-execution/_images/mma-1684-C.png)
>
> Figure 73 MMA .m16n8k4 fragment layout for accumulator matrix C/D with `.f64` type.
>
> The row and column of a matrix fragment can be computed as:
>
> ```ptx
...
<a id="warp-level-matrix-fragment-mma-1688"></a>

<a id="id422"></a>

#####  9.7.16.5.7. Matrix Fragments for `mma.m16n8k8`
...
>
> The layout of the fragments held by different threads is shown in [Figure 74](#mma-1688-a-f16).
>
> <a id="mma-1688-a-f16"></a>
>
> ![_images/mma-1688-A-f16.png](https://docs.nvidia.com/cuda/parallel-thread-execution/_images/mma-1688-A-f16.png)
>
> Figure 74 MMA .m16n8k8 fragment layout for matrix A with `.f16` / `.bf16` type.
>
> The row and column of a matrix fragment can be computed as:
>
> ```ptx
...
>
> The layout of the fragments held by different threads is shown in [Figure 75](#mma-1688-a-tf32).
>
> <a id="mma-1688-a-tf32"></a>
>
> ![_images/mma-1688-A-tf32.png](https://docs.nvidia.com/cuda/parallel-thread-execution/_images/mma-1688-A-tf32.png)
>
> Figure 75 MMA .m16n8k8 fragment layout for matrix A with `.tf32` type.
>
> The row and column of a matrix fragment can be computed as:
>
> ```ptx
...
The layout of the fragments held by different threads is shown in [Figure 76](#mma-1688-a-f64).

<a id="mma-1688-a-f64"></a>

![_images/mma-1688-A-tf32.png](https://docs.nvidia.com/cuda/parallel-thread-execution/_images/mma-1688-A-tf32.png)

Figure 76 MMA .m16n8k8 fragment layout for matrix A with `.f64` type.
...
>
> The layout of the fragments held by different threads is shown in [Figure 77](#mma-1688-b-f16).
>
> <a id="mma-1688-b-f16"></a>
>
> ![_images/mma-1688-B-f16.png](https://docs.nvidia.com/cuda/parallel-thread-execution/_images/mma-1688-B-f16.png)
>
> Figure 77 MMA .m16n8k8 fragment layout for matrix B with `.f16` / `.bf16` type.
>
> The row and column of a matrix fragment can be computed as:
>
> ```ptx
...
>
> The layout of the fragments held by different threads is shown in [Figure 78](#mma-1688-b-tf32).
>
> <a id="mma-1688-b-tf32"></a>
>
> ![_images/mma-1688-B-tf32.png](https://docs.nvidia.com/cuda/parallel-thread-execution/_images/mma-1688-B-tf32.png)
>
> Figure 78 MMA .m16n8k8 fragment layout for matrix B with `.tf32` type.
>
> The row and column of a matrix fragment can be computed as:
>
> ```ptx
...
>
> The layout of the fragments held by different threads is shown in [Figure 79](#mma-1688-b-f64).
>
> <a id="mma-1688-b-f64"></a>
>
> ![_images/mma-1688-B-tf32.png](https://docs.nvidia.com/cuda/parallel-thread-execution/_images/mma-1688-B-tf32.png)
>
> Figure 79 MMA .m16n8k8 fragment layout for matrix B with `.f64` type.
>
> The row and column of a matrix fragment can be computed as:
>
> ```ptx
...
>
> The layout of the fragments held by different threads is shown in [Figure 80](#mma-1688-c-f16-f32).
>
> <a id="mma-1688-c-f16-f32"></a>
>
> ![_images/mma-1688-C.png](https://docs.nvidia.com/cuda/parallel-thread-execution/_images/mma-1688-C.png)
>
> Figure 80 MMA .m16n8k8 fragment layout for accumulator matrix C/D with `.f16x2`/`.f32` type.
>
> The row and column of a matrix fragment can be computed as:
>
> ```ptx
...
>
> The layout of the fragments held by different threads is shown in [Figure 81](#mma-1688-c-f64).
>
> <a id="mma-1688-c-f64"></a>
>
> ![_images/mma-1688-C.png](https://docs.nvidia.com/cuda/parallel-thread-execution/_images/mma-1688-C.png)
>
> Figure 81 MMA .m16n8k8 fragment layout for accumulator matrix C/D with `.f64` type.
>
> The row and column of a matrix fragment can be computed as:
>
> ```ptx
...
<a id="warp-level-matrix-fragment-mma-16816-float"></a>

<a id="id423"></a>

#####  9.7.16.5.8. Matrix Fragments for `mma.m16n8k16` with floating point type
...
>
> The layout of the fragments held by different threads is shown in [Figure 82](#mma-16816-a-f16).
>
> <a id="mma-16816-a-f16"></a>
>
> ![_images/mma-16816-A-f16.png](https://docs.nvidia.com/cuda/parallel-thread-execution/_images/mma-16816-A-f16.png)
>
> Figure 82 MMA .m16n8k16 fragment layout for matrix A with `.f16` / `.bf16` type.
>
> The row and column of a matrix fragment can be computed as:
>
> ```ptx
...
>
> The layout of the fragments held by different threads is shown in [Figure 83](#mma-16816-a-f64).
>
> <a id="mma-16816-a-f64"></a>
>
> ![_images/mma-16816-A-f64.png](https://docs.nvidia.com/cuda/parallel-thread-execution/_images/mma-16816-A-f64.png)
>
> Figure 83 MMA .m16n8k16 fragment layout for matrix A with `.f64` type.
>
> The row and column of a matrix fragment can be computed as:
>
> ```ptx
...
>
> The layout of the fragments held by different threads is shown in [Figure 84](#mma-16816-b-f16).
>
> <a id="mma-16816-b-f16"></a>
>
> ![_images/mma-16816-B-f16.png](https://docs.nvidia.com/cuda/parallel-thread-execution/_images/mma-16816-B-f16.png)
>
> Figure 84 MMA .m16n8k16 fragment layout for matrix B with `.f16` / `.bf16` type.
>
...
>
> The layout of the fragments held by different threads is shown in [Figure 85](#mma-16816-b-f64).
>
> <a id="mma-16816-b-f64"></a>
>
...
>
> Figure 85 MMA .m16n8k16 fragment layout for matrix B with `.f64` type.
>
> The row and column of a matrix fragment can be computed as:
>
> ```ptx
...
<td><p>A vector expression containing four <code><span>.f64</span></code> registers containing
<code><span>.f64</span></code> elements from the matrix C (or D).</p></td>
<td rowspan="3"><p>c0, c1, c2, c3</p></td>
</tr>
<tr>
<td><p><code><span>.f32</span></code></p></td>
<td><p>A vector expression containing four <code><span>.f32</span></code> registers containing
four <code><span>.f32</span></code> elements from the matrix C (or D).</p></td>
</tr>
<tr>
<td><p><code><span>.f16</span></code></p></td>
<td><p>A vector expression containing two <code><span>.f16x2</span></code> registers, with each
register containing two <code><span>.f16</span></code> elements from the matrix C (or D).</p></td>
</tr>
</tbody>
</table>

The layout of the fragments held by different threads is shown in [Figure 86](#mma-16816-c).

<a id="mma-16816-c"></a>

![_images/mma-16816-C-f16.png](https://docs.nvidia.com/cuda/parallel-thread-execution/_images/mma-16816-C-f16.png)

Figure 86 MMA .m16n8k16 fragment layout for accumulator matrix matrix C/D.
...
<a id="warp-level-matrix-fragment-mma-16816-i8-f8"></a>

<a id="id424"></a>

#####  9.7.16.5.9. Matrix Fragments for `mma.m16n8k16` with integer type
...
The layout of the fragments held by different threads is shown in [Figure 87](#mma-16816-a-i8).

<a id="mma-16816-a-i8"></a>

![_images/mma-16816-A-i8.png](https://docs.nvidia.com/cuda/parallel-thread-execution/_images/mma-16816-A-i8.png)

Figure 87 MMA .m16n8k16 fragment layout for matrix A with `.u8` / `.s8` type.
...
The layout of the fragments held by different threads is shown in [Figure 88](#mma-16816-b-i8).

<a id="mma-16816-b-i8"></a>

![_images/mma-16816-B-i8.png](https://docs.nvidia.com/cuda/parallel-thread-execution/_images/mma-16816-B-i8.png)

Figure 88 MMA .m16n8k16 fragment layout for matrix B with `.u8` / `.s8` type.
...
The layout of the fragments held by different threads is shown in [Figure 89](#mma-16816-c-i8).

<a id="mma-16816-c-i8"></a>

![_images/mma-16816-C-i8.png](https://docs.nvidia.com/cuda/parallel-thread-execution/_images/mma-16816-C-i8.png)

Figure 89 MMA .m16n8k16 fragment layout for accumulator matrix C/D with `.s32` type.
...
<a id="warp-level-matrix-fragment-mma-16832"></a>

<a id="id425"></a>

#####  9.7.16.5.10. Matrix Fragments for `mma.m16n8k32`
...
>
> The layout of the fragments held by different threads is shown in [Figure 90](#mma-16832-a-i4).
>
> <a id="mma-16832-a-i4"></a>
>
> ![_images/mma-16832-A-i4.png](https://docs.nvidia.com/cuda/parallel-thread-execution/_images/mma-16832-A-i4.png)
>
> Figure 90 MMA .m16n8k32 fragment layout for matrix A with `.u4` / `.s4` type.
>
> The row and column of a matrix fragment can be computed as:
>
> ```ptx
...
>
> The layout of the fragments held by different threads is shown in [Figure 91](#mma-16832-a-i8).
>
> <a id="mma-16832-a-i8"></a>
>
> ![_images/mma-16832-A-i8.png](https://docs.nvidia.com/cuda/parallel-thread-execution/_images/mma-16832-A-i8.png)
>
> Figure 91 MMA .m16n8k32 fragment layout for matrix A with `.u8` / `.s8` / `.e4m3` / `.e5m2` / `.e3m2` / `.e2m3` / `.e2m1` type.
>
> The row and column of a matrix fragment can be computed as:
>
> ```ptx
...
>
> The layout of the fragments held by different threads is shown in [Figure 92](#mma-16832-b-i4).
>
> <a id="mma-16832-b-i4"></a>
>
> ![_images/mma-16832-B-i4.png](https://docs.nvidia.com/cuda/parallel-thread-execution/_images/mma-16832-B-i4.png)
>
> Figure 92 MMA .m16n8k32 fragment layout for matrix B with `.u4` / `.s4` type.
>
> The row and column of a matrix fragment can be computed as:
...
>
> The layout of the fragments held by different threads is shown in [Figure 93](#mma-16832-b-i8-1) and [Figure 94](#mma-16832-b-i8-2).
>
> <a id="mma-16832-b-i8-1"></a>
>
> ![_images/mma-16832-B-i8_1.png](https://docs.nvidia.com/cuda/parallel-thread-execution/_images/mma-16832-B-i8_1.png)
>
> Figure 93 MMA .m16n8k32 fragment layout for rows 0–15 of matrix B with `.u8` / `.s8` / `.e4m3` / `.e5m2` / `.e3m2` / `.e2m3` / `.e2m1` type.
>
> <a id="mma-16832-b-i8-2"></a>
>
> ![_images/mma-16832-B-i8_2.png](https://docs.nvidia.com/cuda/parallel-thread-execution/_images/mma-16832-B-i8_2.png)
>
> Figure 94 MMA .m16n8k32 fragment layout for rows 16–31 of matrix B with `.u8` / `.s8` / `.e4m3` / `.e5m2` / `.e3m2` / `.e2m3` / `.e2m1` type.
>
> The row and column of a matrix fragment can be computed as:
>
> ```ptx
...
The layout of the fragments held by different threads is shown in [Figure 95](#mma-16832-c).

<a id="mma-16832-c"></a>

![_images/mma-16832-C.png](https://docs.nvidia.com/cuda/parallel-thread-execution/_images/mma-16832-C.png)

Figure 95 MMA .m16n8k32 fragment layout for accumulator matrix C/D with `.s32` / `.f32` / `.f16` type.
...
<a id="warp-level-matrix-fragment-mma-16864"></a>

<a id="id426"></a>

#####  9.7.16.5.11. Matrix Fragments for `mma.m16n8k64`
...
The layout of the fragments held by different threads is shown in [Figure 96](#mma-16864-a).

<a id="mma-16864-a"></a>

![_images/mma-16864-A.png](https://docs.nvidia.com/cuda/parallel-thread-execution/_images/mma-16864-A.png)

Figure 96 MMA .m16n8k64 fragment layout for matrix A with `.u4` / `.s4` / `.e2m1` type.
...
The layout of the fragments held by different threads is shown in [Figure 97](#mma-16864-b-1) and [Figure 98](#mma-16864-b-2).

<a id="mma-16864-b-1"></a>

![_images/mma-16864-B_1.png](https://docs.nvidia.com/cuda/parallel-thread-execution/_images/mma-16864-B_1.png)

Figure 97 MMA .m16n8k64 fragment layout for rows 0–31 of matrix B with `.u4` / `.s4` / `.e2m1` type.

<a id="mma-16864-b-2"></a>

![_images/mma-16864-B_2.png](https://docs.nvidia.com/cuda/parallel-thread-execution/_images/mma-16864-B_2.png)

Figure 98 MMA .m16n8k64 fragment layout for rows 32–63 of matrix B with `.u4` / `.s4` / `.e2m1` type.
...
The layout of the fragments held by different threads is shown in [Figure 99](#mma-16864-c).

<a id="mma-16864-c"></a>

![_images/mma-16864-C.png](https://docs.nvidia.com/cuda/parallel-thread-execution/_images/mma-16864-C.png)

Figure 99 MMA .m16n8k64 fragment layout for accumulator matrix C/D with `.s32` / `.f32` type.
...
<a id="warp-level-matrix-fragment-mma-168128"></a>

<a id="id427"></a>

#####  9.7.16.5.12. Matrix Fragments for `mma.m16n8k128`
...
The layout of the fragments held by different threads is shown in [Figure 100](#mma-168128-a).

<a id="mma-168128-a"></a>

![_images/mma-168128-A.png](https://docs.nvidia.com/cuda/parallel-thread-execution/_images/mma-168128-A.png)

Figure 100 MMA .m16n8k128 fragment layout for matrix A with `.b1` type.
...
The layout of the fragments held by different threads is shown in [Figure 101](#mma-168128-b).

<a id="mma-168128-b"></a>

![_images/mma-168128-B.png](https://docs.nvidia.com/cuda/parallel-thread-execution/_images/mma-168128-B.png)

Figure 101 MMA .m16n8k128 fragment layout for matrix B with `.b1` type.
...
The layout of the fragments held by different threads is shown in [Figure 102](#mma-168128-c).

<a id="mma-168128-c"></a>

![_images/mma-168128-C.png](https://docs.nvidia.com/cuda/parallel-thread-execution/_images/mma-168128-C.png)

Figure 102 MMA .m16n8k128 fragment layout for accumulator matrix C/D with `.s32` type.
...
<a id="warp-level-matrix-fragment-mma-168256"></a>

<a id="id428"></a>

#####  9.7.16.5.13. Matrix Fragments for `mma.m16n8k256`
...
The layout of the fragments held by different threads is shown in [Figure 103](#mma-168256-a).

<a id="mma-168256-a"></a>

![_images/mma-168256-A.png](https://docs.nvidia.com/cuda/parallel-thread-execution/_images/mma-168256-A.png)

Figure 103 MMA .m16n8k256 fragment layout for matrix A with `.b1` type.
...
The layout of the fragments held by different threads is shown in [Figure 104](#mma-168256-b-1) and [Figure 105](#mma-168256-b-2).

<a id="mma-168256-b-1"></a>

![_images/mma-168256-B_1.png](https://docs.nvidia.com/cuda/parallel-thread-execution/_images/mma-168256-B_1.png)

Figure 104 MMA .m16n8k256 fragment layout for rows 0–127 of matrix B with `.b1` type.

<a id="mma-168256-b-2"></a>

![_images/mma-168256-B_2.png](https://docs.nvidia.com/cuda/parallel-thread-execution/_images/mma-168256-B_2.png)

Figure 105 MMA .m16n8k256 fragment layout for rows 128–255 of matrix B with `.b1` type.
...
The layout of the fragments held by different threads is shown in [Figure 106](#mma-168256-c).

<a id="mma-168256-c"></a>

![_images/mma-168256-C.png](https://docs.nvidia.com/cuda/parallel-thread-execution/_images/mma-168256-C.png)

Figure 106 MMA .m16n8k256 fragment layout for accumulator matrix C/D with `.s32` type.
...
<a id="warp-level-matrix-instructions-mma"></a>

<a id="id429"></a>

#####  9.7.16.5.14. Multiply-and-Accumulate Instruction: `mma`
...
<a id="warp-level-matrix-instructions-ldmatrix"></a>

<a id="id430"></a>

#####  9.7.16.5.15. Warp-level matrix load instruction: `ldmatrix`
...
<tbody>
<tr>
<td rowspan="2"><p><code><span>.b6x16_p32</span></code></p></td>
<td><p><code><span>.m8n16</span></code></p></td>
<td rowspan="2"><p>16 6-bit elements</p></td>
<td rowspan="2"><p>32 bits</p></td>
<td rowspan="4"><p><code><span>.b8x16</span></code>
(16 8-bit
elements)</p></td>
</tr>
<tr>
<td><p><code><span>.m16n16</span></code></p></td>
</tr>
<tr>
<td rowspan="2"><p><code><span>.b4x16_p64</span></code></p></td>
<td><p><code><span>.m8n16</span></code></p></td>
...
Following table shows the valid use of 4-bit load expanded to 8-bit.

.ctype | .shape | Source data | .dtype
---|---|---|---
`.s4` | `.m8n16` | Signed 4-bit elements | `.s8`

For `.s4` type, the source data is a sequence of signed 4-bit elements that are expanded to signed 8-bit values during load.
...
Supported addressing modes for `p` are described in [Addresses as Operands](../6-instruction-operands/6.4.1-addresses-as-operands.md#addresses-as-operands).
...
Each thread in a warp loads fragments of a row, with thread 0 receiving the first fragment in its register `r`, and so on. A group of four threads loads an entire row of the matrix as shown in [Figure 107](#mma-ldmatrix-fragments).

<a id="mma-ldmatrix-fragments"></a>
...
Figure 107 ldmatrix fragment layout for one 8x8 Matrix with 16-bit elements
...
For matrix shape 16x16, two destination registers `r0` and `r1` of type `.b32` must be specified and in each register four 8-bit elements are loaded. For 4-bit or 6-bit data, 8-bit element will have 4 bits or 2 bits of padding respectively.

An entire row of the matrix can be loaded by a group of four consecutive and aligned threads. Each thread in a warp loads 4 consecutive columns across 2 rows as shown in the [Figure 108](#mma-ldmatrix-fragments-1616).

<a id="mma-ldmatrix-fragments-1616"></a>
...
Figure 108 ldmatrix fragment layout for one 16x16 matrix with 8-bit elements
...
An entire row of the matrix can be loaded by a group of four consecutive and aligned threads. Each thread in a warp loads 4 consecutive columns as shown in [Figure 109](#mma-ldmatrix-fragments-816).

<a id="mma-ldmatrix-fragments-816"></a>
...
Figure 109 ldmatrix fragment layout for one 8x16 matrix with 8-bit elements containing 4-bit/6-bit data
...
The `ldmatrix` instruction is treated as a weak memory operation in the [Memory Consistency Model](../8-memory-consistency-model/8-memory-consistency-model.md#memory-consistency-model).
...
Support for `.s8.s4` types introduced in PTX ISA version 9.4.
...
Types `.s8.s4` are supported on following architectures:
...
// Load one 8x16 matrix of 4-bit signed elements expanded to 8-bit signed
.reg .b64 addr;
.reg .b32 d;
ldmatrix.sync.aligned.m8n16.x1.shared::cta.s8.s4 {d}, [addr];
```

<a id="warp-level-matrix-instructions-stmatrix"></a>

<a id="id431"></a>

#####  9.7.16.5.16. Warp-level matrix store instruction: `stmatrix`
...
Each thread in a warp stores fragments of a row, with thread 0 storing the first fragment from its register `r`, and so on. A group of four threads stores an entire row of the matrix as shown in [Figure 110](#mma-stmatrix-fragments).

<a id="mma-stmatrix-fragments"></a>
...
Figure 110 stmatrix fragment layout for one 8x8 matrix with 16-bit elements
...
<a id="mma-stmatrix-fragments-168"></a>
...
Figure 111 stmatrix fragment layout for one 16x8 matrix with 8 bit elements
...
The `stmatrix` instruction is treated as a weak memory operation in the [Memory Consistency Model](../8-memory-consistency-model/8-memory-consistency-model.md#memory-consistency-model).
...
<a id="warp-level-matrix-instructions-movmatrix"></a>

<a id="id432"></a>

#####  9.7.16.5.17. Warp-level matrix transpose instruction: `movmatrix`
...
Each thread in a warp holds a fragment of a row of the input matrix, with thread 0 holding the first fragment in register `a`, and so on. A group of four threads holds an entire row of the input matrix as shown in [Figure 112](#mma-movmatrix-fragments-src).

<a id="mma-movmatrix-fragments-src"></a>
...
Figure 112 movmatrix source matrix fragment layout

Each thread in a warp holds a fragment of a column of the result matrix, with thread 0 holding the first fragment in register `d`, and so on. A group of four threads holds an entire column of the result matrix as shown in [Figure 113](#mma-movmatrix-fragments-dst).

<a id="mma-movmatrix-fragments-dst"></a>
...
Figure 113 movmatrix result matrix fragment layout
