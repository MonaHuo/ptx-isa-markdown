---
title: "9.7.15.5. Parallel Synchronization and Communication Instructions: atom"
section: "9.7.15.5"
version: "9.4"
...
<a id="parallel-synchronization-and-communication-instructions-atom"></a>
...
The optional `.sem` qualifier specifies a memory synchronizing effect as described in the [Memory Consistency Model](../8-memory-consistency-model/8-memory-consistency-model.md#memory-consistency-model). If the `.sem` qualifier is absent, `.relaxed` is assumed by default.

The optional `.scope` qualifier specifies the set of threads that can directly observe the memory synchronizing effect of this operation, as described in the [Memory Consistency Model](../8-memory-consistency-model/8-memory-consistency-model.md#memory-consistency-model). If the `.scope` qualifier is absent, `.gpu` scope is assumed by default.

[Table 41](#atom-scalar-type-operations-table) shows the valid combinations of types and atomic operations for scalar `atom` instructions.

<a id="atom-scalar-type-operations-table"></a>
...
<thead>
<tr>
<th rowspan="2"><p>Vector qualifier</p></th>
<th colspan="3"><p>Types</p></th>
</tr>
<tr>
<th><p><code><span>.f16</span></code>/ <code><span>bf16</span></code></p></th>
<th><p><code><span>.f16x2</span></code>/ <code><span>bf16x2</span></code></p></th>
<th><p><code><span>.f32</span></code></p></th>
</tr>
</thead>
<tbody>
<tr>
<td><p><code><span>.v2</span></code></p></td>
<td><p><code><span>.add</span></code>, <code><span>.min</span></code>, <code><span>.max</span></code>
(all require <code><span>.noftz</span></code>)</p></td>
<td><p><code><span>.add</span></code>, <code><span>.min</span></code>, <code><span>.max</span></code>
(all require <code><span>.noftz</span></code>)</p></td>
<td><p><code><span>.add</span></code></p></td>
</tr>
<tr>
<td><p><code><span>.v4</span></code></p></td>
<td><p><code><span>.add</span></code>, <code><span>.min</span></code>, <code><span>.max</span></code>
(all require <code><span>.noftz</span></code>)</p></td>
<td><p><code><span>.add</span></code>, <code><span>.min</span></code>, <code><span>.max</span></code>
(all require <code><span>.noftz</span></code>)</p></td>
...
<tr>
<td><p><code><span>.v8</span></code></p></td>
<td><p><code><span>.add</span></code>, <code><span>.min</span></code>, <code><span>.max</span></code>
(all require <code><span>.noftz</span></code>)</p></td>
