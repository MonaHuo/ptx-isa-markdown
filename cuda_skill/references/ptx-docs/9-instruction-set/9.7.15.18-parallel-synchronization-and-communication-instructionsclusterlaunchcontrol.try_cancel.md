---
title: "9.7.15.18. Parallel Synchronization and Communication Instructions: clusterlaunchcontrol.try_cancel"
section: "9.7.15.18"
version: "9.4"
...
<a id="parallel-synchronization-and-communication-instructions-clusterlaunchcontrol-try-cancel"></a>

<a id="id403"></a>

####  9.7.15.18. Parallel Synchronization and Communication Instructions: `clusterlaunchcontrol.try_cancel`
...
The qualifier `.completion_mechanism` specifies that upon completion of the asynchronous operation, [complete-tx](9.7.15.16-parallel-synchronization-and-communication-instructionsmbarrier.md#parallel-synchronization-and-communication-instructions-mbarrier-complete-tx-operation) operation, with `completeCount` argument equal to amount of data stored in bytes, will be performed on the mbarrier object specified by the operand `mbar`.

The executing thread can then use [mbarrier instructions](9.7.15.16-parallel-synchronization-and-communication-instructionsmbarrier.md#parallel-synchronization-and-communication-instructions-mbarrier) to wait for completion of the asynchronous operation. No other synchronization mechanisms described in [Memory Consistency Model](../8-memory-consistency-model/8-memory-consistency-model.md#memory-consistency-model) can be used to guarantee the completion of the asynchronous copy operations.
