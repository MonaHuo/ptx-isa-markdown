---
title: "9.7.21.5. Miscellaneous Instructions: setmaxnreg"
section: "9.7.21.5"
version: "9.4"
url: https://docs.nvidia.com/cuda/parallel-thread-execution/index.html#miscellaneous-instructions-setmaxnreg
---

<a id="miscellaneous-instructions-setmaxnreg"></a>

<a id="id614"></a>

####  9.7.21.5. Miscellaneous Instructions: `setmaxnreg`
...
The same `setmaxnreg` instruction must be executed by all warps in a [warpgroup](9.7.17.1-warpgroup.md#asynchronous-warpgroup-level-matrix-instructions-warpgroup). After executing a `setmaxnreg` instruction, all warps in the _warpgroup_ must synchronize explicitly before executing subsequent setmaxnreg instructions. If a `setmaxnreg` instruction is not executed by all warps in the _warpgroup_ , then the behavior is undefined.
