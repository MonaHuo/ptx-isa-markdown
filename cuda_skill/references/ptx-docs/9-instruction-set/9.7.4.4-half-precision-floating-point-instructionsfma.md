---
title: "9.7.4.4. Half Precision Floating Point Instructions: fma"
section: "9.7.4.4"
version: "9.4"
url: https://docs.nvidia.com/cuda/parallel-thread-execution/index.html#half-precision-floating-point-instructions-fma
---

<a id="half-precision-floating-point-instructions-fma"></a>
...
`fma.oob.{f16, f16x2, bf16, bf16x2}` clamps the result to 0 if either of the operands is `OOB NaN` (defined under [Tensors](../5-state-spaces-types-and-variables/5.5-tensors.md#tensors)) value. The test for the special `NaN` value and resultant forcing of the result to +0.0 is performed independently for each of the two SIMD operations.
