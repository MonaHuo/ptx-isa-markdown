---
title: "13.27. Changes in PTX ISA Version 6.2"
section: "13.27"
version: "9.4"
url: https://docs.nvidia.com/cuda/parallel-thread-execution/index.html#changes-in-ptx-isa-version-6-2
---

<a id="changes-in-ptx-isa-version-6-2"></a>

<a id="id727"></a>

##  13.27. Changes in PTX ISA Version 6.2
...
PTX ISA version 6.2 deprecates the following features:
  ...
  * The use of `shfl` and `vote` instructions without the `.sync` is deprecated retrospectively from PTX ISA version 6.0, which introduced the `sm_70` architecture that implements [Independent Thread Scheduling](../3-ptx-machine-model/3.2-independent-thread-scheduling.md#independent-thread-scheduling).
