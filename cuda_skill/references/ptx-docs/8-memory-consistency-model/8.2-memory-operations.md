---
title: "8.2. Memory operations"
section: "8.2"
version: "9.4"
url: https://docs.nvidia.com/cuda/parallel-thread-execution/index.html#memory-operations
---
...
- [8.2.1. Overlap](8.2.1-overlap.md)
- [8.2.2. Aliases](8.2.2-aliases.md)
- [8.2.3. Multimem Addresses](8.2.3-multimem-addresses.md)
- [8.2.4. Memory Operations on Vector Data Types](8.2.4-memory-operations-on-vector-data-types.md)
- [8.2.5. Memory Operations on Packed Data Types](8.2.5-memory-operations-on-packed-data-types.md)
- [8.2.6. Initialization](8.2.6-initialization.md)
