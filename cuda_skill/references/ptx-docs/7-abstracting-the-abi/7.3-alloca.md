...
section: "7.3"
version: "9.4"
url: https://docs.nvidia.com/cuda/parallel-thread-execution/index.html#alloca
---
...
`alloca`, `stacksave`, and `stackrestore` instructions are described in [Stack Manipulation Instructions](../9-instruction-set/9.7.19-stack-manipulation-instructions.md#stack-manipulation-instructions).
