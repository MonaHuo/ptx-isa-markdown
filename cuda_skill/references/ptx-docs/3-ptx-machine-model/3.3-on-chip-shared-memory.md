...
section: "3.3"
version: "9.4"
url: https://docs.nvidia.com/cuda/parallel-thread-execution/index.html#on-chip-shared-memory
---

<a id="on-chip-shared-memory"></a>

<a id="id16"></a>

##  3.3. On-chip Shared Memory

As illustrated by [Figure 4](3.1-a-set-of-simt-multiprocessors.md#set-of-simt-multiprocessors-hardware-model), each multiprocessor has on-chip memory of the four following types:
