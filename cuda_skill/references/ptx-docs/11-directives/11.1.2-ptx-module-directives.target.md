...
string = { sm_120a, sm_120f, sm_120,          // sm_12x target architectures
           ...
           sm_107a, sm_107f, sm_107           // sm_10x target architectures
...
[Table 70](#architecture-family-definition) defines the architecture families.

<a id="architecture-family-definition"></a>

Table 70 Architecture Families
...
`sm_107` | Baseline feature set for `sm_107` architecture.
`sm_107f` | Adds support for `sm_107f` family specific features.
`sm_107a` | Adds support for `sm_107a` architecture-specific features.
Target | Description
---|---
...
`sm_53` | Adds support for arithmetic, comparison and texture instructions for `.f16` and `.f16x2` types.
Target | Description
---|---
...
Target string `sm_107` introduced in PTX ISA version 9.4.

Target string `sm_107f` introduced in PTX ISA version 9.4.

Target string `sm_107a` introduced in PTX ISA version 9.4.
