...
an array element as described in [Arrays as Operands](6.4.2-arrays-as-operands.md#arrays-as-operands).
...
- [6.4.1.1. Generic Addressing](6.4.1.1-generic-addressing.md)
