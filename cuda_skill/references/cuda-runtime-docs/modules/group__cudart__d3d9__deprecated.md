...
Source: https://docs.nvidia.com/cuda/cuda-runtime-api/cuda_runtime_api/group__CUDART__D3D9__DEPRECATED.html

#  6.10. Direct3D 9 Interoperability [DEPRECATED]
...
`` enumerator cudaD3D9MapFlagsNone ``

Default; Assume resource can be read/written.

`` enumerator cudaD3D9MapFlagsReadOnly ``

CUDA kernels will not write to this resource.

`` enumerator cudaD3D9MapFlagsWriteDiscard ``
...
`` enumerator cudaD3D9RegisterFlagsNone ``

Default; Resource can be accessed througa void*.

`` enumerator cudaD3D9RegisterFlagsArray ``

Resource can be accessed through a CUarray*.

##  6.10.2. Functions

`` __host__ cudaError_t cudaD3D9Begin(IDirect3DDevice9 *pDevice) ``

`` __host__ cudaError_t cudaD3D9End(void) ``
...
`` __host__ cudaError_t cudaD3D9MapVertexBuffer(void **dptr, IDirect3DVertexBuffer9 *pVB) ``
...
`` __host__ cudaError_t cudaD3D9RegisterVertexBuffer(IDirect3DVertexBuffer9 *pVB) ``
...
`` __host__ cudaError_t cudaD3D9UnmapVertexBuffer(IDirect3DVertexBuffer9 *pVB) ``
...
`` __host__ cudaError_t cudaD3D9UnregisterVertexBuffer(IDirect3DVertexBuffer9 *pVB) ``
