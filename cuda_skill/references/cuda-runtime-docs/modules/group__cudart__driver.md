...
Source: https://docs.nvidia.com/cuda/cuda-runtime-api/cuda_runtime_api/group__CUDART__DRIVER.html

#  6.22. Interactions with the CUDA Driver API

This section describes the interactions between the CUDA Driver API and the CUDA Runtime API.

##  6.22.1. Execution Contexts
...
##  6.22.2. Primary Context (aka Device Execution Context)
...
##  6.22.3. Initialization and Tear-Down
...
##  6.22.4. CUcontext Interoperability
...
##  6.22.5. Interactions between CUstream and cudaStream_t

The types ::CUstream and cudaStream_t are identical and may be used interchangeably.

##  6.22.6. Interactions between CUevent and cudaEvent_t

The types ::CUevent and cudaEvent_t are identical and may be used interchangeably.

##  6.22.7. Interactions between CUarray and cudaArray_t
...
##  6.22.8. Interactions between CUgraphicsResource and cudaGraphicsResource_t
...
##  6.22.9. Interactions between CUtexObject and cudaTextureObject_t
...
##  6.22.10. Interactions between CUsurfObject and cudaSurfaceObject_t
...
##  6.22.11. Interactions between CUfunction and cudaFunction_t
...
##  6.22.12. Interactions between CUkernel and cudaKernel_t
