...
Source: https://docs.nvidia.com/cuda/cuda-driver-api/cuda_driver_api/group__CUDA__EXEC.html

#  6.16. Execution Control

This section describes the execution control functions of the low-level CUDA driver application programming interface.

##  6.16.1. Enumerations

`` enum CUfunctionLoadingState ``

_Values:_

`` enumerator CU_FUNCTION_LOADING_STATE_UNLOADED ``

`` enumerator CU_FUNCTION_LOADING_STATE_LOADED ``

`` enumerator CU_FUNCTION_LOADING_STATE_MAX ``
