...
Source: https://docs.nvidia.com/cuda/cuda-driver-api/cuda_driver_api/group__CUDA__TENSOR__MEMORY.html

#  6.41. Tensor Map Object Managment
...
The tensor core API is only supported on devices of compute capability 9.0 or higher.
