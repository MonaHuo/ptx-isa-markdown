...
Source: https://docs.nvidia.com/cuda/cuda-driver-api/cuda_driver_api/group__CUDA__D3D10__DEPRECATED.html
...
`` enumerator CU_D3D10_MAPRESOURCE_FLAGS_NONE ``

`` enumerator CU_D3D10_MAPRESOURCE_FLAGS_READONLY ``

`` enumerator CU_D3D10_MAPRESOURCE_FLAGS_WRITEDISCARD ``
...
`` enumerator CU_D3D10_REGISTER_FLAGS_NONE ``

`` enumerator CU_D3D10_REGISTER_FLAGS_ARRAY ``
