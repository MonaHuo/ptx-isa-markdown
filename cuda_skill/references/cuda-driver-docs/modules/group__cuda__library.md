...
Source: https://docs.nvidia.com/cuda/cuda-driver-api/cuda_driver_api/group__CUDA__LIBRARY.html
...
The `code` may be a _cubin_ or _fatbin_ as output by **nvcc** , or a NULL-terminated _PTX_ , either as output by **nvcc** or hand-written, or _Tile_ IR data. A fatbin should also contain relocatable code when doing separate compilation.
...
The file should be a _cubin_ file as output by **nvcc** , or a _PTX_ file either as output by **nvcc** or handwritten, or a _fatbin_ file as output by **nvcc** or hand-written, or _Tile_ IR file. A fatbin should also contain relocatable code when doing separate compilation.
