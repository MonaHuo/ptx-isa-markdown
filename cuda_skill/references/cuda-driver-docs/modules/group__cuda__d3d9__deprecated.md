...
Source: https://docs.nvidia.com/cuda/cuda-driver-api/cuda_driver_api/group__CUDA__D3D9__DEPRECATED.html

#  6.10.1. Direct3D 9 Interoperability [DEPRECATED]

This section describes deprecated Direct3D 9 interoperability functionality.

##  6.10.1.1. Enumerations
...
`` enumerator CU_D3D9_MAPRESOURCE_FLAGS_NONE ``

`` enumerator CU_D3D9_MAPRESOURCE_FLAGS_READONLY ``

`` enumerator CU_D3D9_MAPRESOURCE_FLAGS_WRITEDISCARD ``
...
`` enumerator CU_D3D9_REGISTER_FLAGS_NONE ``

`` enumerator CU_D3D9_REGISTER_FLAGS_ARRAY ``

##  6.10.1.2. Functions

`` CUresult cuD3D9Begin(IDirect3DDevice9 *pDevice) ``
...
`` CUresult cuD3D9MapVertexBuffer(CUdeviceptr *pDevPtr, size_t *pSize, IDirect3DVertexBuffer9 *pVB) ``
...
`` CUresult cuD3D9RegisterVertexBuffer(IDirect3DVertexBuffer9 *pVB) ``
...
`` CUresult cuD3D9UnmapVertexBuffer(IDirect3DVertexBuffer9 *pVB) ``
...
`` CUresult cuD3D9UnregisterVertexBuffer(IDirect3DVertexBuffer9 *pVB) ``
